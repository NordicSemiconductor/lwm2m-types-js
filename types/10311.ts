 ...
 * Solar Radiation
 *
 * This Object is used to report solar irradiance (SI), i.e. power per unit area
 * received from the Sun in the form of electromagnetic radiation, on a planar
 * surface measured by a pyranometer or similar instrument. A pyranometer
 * measures solar irradiance from the hemisphere above within a wavelength range
 * 0.3 um to 3 um. For example, the application of solar radiation measurement
 * can be meterological networks and solar energy applications.
 *
 * @see https://github.com/OpenMobileAlliance/lwm2m-registry/raw/prod/10311.xml
 *
 * ID: 10311
 * LWM2MVersion: 1.0
 * ObjectVersion: 1.1
 ...
 * Mandatory: false
 */
export type SolarRadiation_10311 = Readonly<
	Array<{
...
/**
 * The objectURN for Solar Radiation
 * Used in the JSON schema for the LwM2M document definition as a key.
 */
export const objectURN = '10311:1.1'
