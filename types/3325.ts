 ...
 * Concentration
 *
 * This IPSO object should be used to the particle concentration measurement of
 * a medium. It also provides resources for minimum and maximum measured values,
 * as well as the minimum and maximum range that can be measured by the sensor.
 * An example measurement unit is parts per million.
 *
 *
 * @see https://github.com/OpenMobileAlliance/lwm2m-registry/raw/prod/3325.xml
 *
 * ID: 3325
 * LWM2MVersion: 1.0
 * ObjectVersion: 1.1
 ...
 * Mandatory: false
 */
export type Concentration_3325 = Readonly<
	Array<{
...
/**
 * The objectURN for Concentration
 * Used in the JSON schema for the LwM2M document definition as a key.
 */
export const objectURN = '3325:1.1'
