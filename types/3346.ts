 ...
 * Rate
 *
 * This object type should be used to report a rate measurement, for example the
 * speed of a vehicle, or the rotational speed of a drive shaft. It also
 ...
 *
 *
 * @see https://github.com/OpenMobileAlliance/lwm2m-registry/raw/prod/3346.xml
 *
 * ID: 3346
 * LWM2MVersion: 1.0
 * ObjectVersion: 1.1
 ...
 * Mandatory: false
 */
export type Rate_3346 = Readonly<
	Array<{
...
/**
 * The objectURN for Rate
 * Used in the JSON schema for the LwM2M document definition as a key.
 */
export const objectURN = '3346:1.1'
