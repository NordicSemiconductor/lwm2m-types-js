 ...
 * Pressure Transient
 *
 * Object for measuring high frequency pressure readings and summarizing/logging
 * them at defined intervals. This way, the raw data does not need to be sent
 * over the air, and instead just the Average , Maximum and Minimum values for
 * the interval
 *
 * @see https://github.com/OpenMobileAlliance/lwm2m-registry/raw/prod/10292.xml
 *
 * ID: 10292
 * LWM2MVersion: 1.0
 * ObjectVersion: 1.0
 ...
 * Mandatory: false
 */
export type PressureTransient_10292 = Readonly<
	Array<{
...
/**
 * The objectURN for Pressure Transient
 * Used in the JSON schema for the LwM2M document definition as a key.
 */
export const objectURN = '10292'
