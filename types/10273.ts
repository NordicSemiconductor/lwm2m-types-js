 ...
 *
 * An alarm indicating reverse flow through the pipe. Also supports delivery of
 * the approximate volume of water flowing in the reverse direction in the
 * preceding period.
 *
 * @see https://github.com/OpenMobileAlliance/lwm2m-registry/raw/prod/10273.xml
 *
 * ID: 10273
 * LWM2MVersion: 1.0
 * ObjectVersion: 1.0
 ...
 * Mandatory: false
 */
export type WaterMeterReverseFlowAlarm_10273 = Readonly<
	Array<{
		'6011': EventType_6011
...
/**
 * The objectURN for Water Meter Reverse Flow Alarm
 * Used in the JSON schema for the LwM2M document definition as a key.
 */
export const objectURN = '10273'
