 ...
 * Altitude
 *
 * This IPSO object should be used with an altitude sensor to report altitude
 * above sea level in meters. Note that Altitude can be calculated from the
 * measured pressure given the local sea level pressure. It also provides
 * resources for minimum and maximum measured values, as well as the minimum and
 * maximum range that can be measured by the sensor. An example measurement unit
 * is meters.
 *
 *
 * @see https://github.com/OpenMobileAlliance/lwm2m-registry/raw/prod/3321.xml
 *
 * ID: 3321
 * LWM2MVersion: 1.0
 * ObjectVersion: 1.1
 ...
 * Mandatory: false
 */
export type Altitude_3321 = Readonly<
	Array<{
...
/**
 * The objectURN for Altitude
 * Used in the JSON schema for the LwM2M document definition as a key.
 */
export const objectURN = '3321:1.1'
