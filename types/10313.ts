 ...
 * methane etc)
 *
 * @see https://github.com/OpenMobileAlliance/lwm2m-registry/raw/prod/10313.xml
 *
 * ID: 10313
 * LWM2MVersion: 1.0
 * ObjectVersion: 1.0
 ...
 * Mandatory: false
 */
export type GasReadings_10313 = Readonly<
	Array<{
 ...
 * Sensor Warm-up Time
 *
 * Warm-up (wait) time before sensor value is read
 *
 * ID: 6041
 * MultipleInstances: false
 * Mandatory: false
 * Units: s
 */
type SensorWarm_upTime_6041 = number
/**
 * The objectURN for Gas Readings
 * Used in the JSON schema for the LwM2M document definition as a key.
 */
export const objectURN = '10313'
