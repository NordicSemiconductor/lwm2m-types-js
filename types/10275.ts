 ...
 *
 * Detects interference from strong magnetic field or other electrical sources.
 * If this is not relevant for ultrasonic meters then the tamper alarm may be
 * used to indicate someone attempting to open the physical enclosure or other
 * options the manufacturer may present.
 *
 * @see https://github.com/OpenMobileAlliance/lwm2m-registry/raw/prod/10275.xml
 *
 * ID: 10275
 * LWM2MVersion: 1.0
 * ObjectVersion: 1.0
 ...
 * Mandatory: false
 */
export type WaterMeterTamperAlarm_10275 = Readonly<
	Array<{
		'6011': EventType_6011
...
/**
 * The objectURN for Water Meter Tamper Alarm
 * Used in the JSON schema for the LwM2M document definition as a key.
 */
export const objectURN = '10275'
