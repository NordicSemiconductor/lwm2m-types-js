 ...
 * Load
 *
 * This IPSO object should be used with a load sensor (as in a scale) to report
 * the applied weight or force. It also provides resources for minimum and
 * maximum measured values, as well as the minimum and maximum range that can be
 * measured by the sensor. An example measurement unit is kilograms.
 *
 *
 * @see https://github.com/OpenMobileAlliance/lwm2m-registry/raw/prod/3322.xml
 *
 * ID: 3322
 * LWM2MVersion: 1.0
 * ObjectVersion: 1.1
 ...
 * Mandatory: false
 */
export type Load_3322 = Readonly<
	Array<{
...
/**
 * The objectURN for Load
 * Used in the JSON schema for the LwM2M document definition as a key.
 */
export const objectURN = '3322:1.1'
