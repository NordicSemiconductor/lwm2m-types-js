 ...
 * packet transmission or receipt for the period. Used to monitor for excess
 * poower usage over time.
 *
 * @see https://github.com/OpenMobileAlliance/lwm2m-registry/raw/prod/10271.xml
 *
 * ID: 10271
 * LWM2MVersion: 1.0
 * ObjectVersion: 1.0
 ...
 * Mandatory: false
 */
export type CommunicationsActivityTimeReadings_10271 = Readonly<
	Array<{
 ...
 * Examples of Interval Period include:-
 * 30 = Every 30 seconds
 ...
 * no new data exists, an empty Opaque value should be provided.
 *
 ...
 * 3. Timestamp of first Interval [32-bit integer] representing the number of
 ...
 *
 * If for some implementation specific reason, there are missing intervals in
 * the sequence, the payload may consist of multiple blocks of the above
 * serialised data (appended into a single binary opaque value), each block
...
/**
 * The objectURN for Communications Activity Time Readings
 * Used in the JSON schema for the LwM2M document definition as a key.
 */
export const objectURN = '10271'
