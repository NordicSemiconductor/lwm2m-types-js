 ...
 * Current
 *
 * This IPSO object should be used with an ammeter to report measured electric
 * current in amperes. It also provides resources for minimum and maximum
 * measured values, as well as the minimum and maximum range that can be
 * measured by the sensor. An example measurement unit is ampere.
 *
 *
 * @see https://github.com/OpenMobileAlliance/lwm2m-registry/raw/prod/3317.xml
 *
 * ID: 3317
 * LWM2MVersion: 1.0
 * ObjectVersion: 1.1
 ...
 * Mandatory: false
 */
export type Current_3317 = Readonly<
	Array<{
...
/**
 * The objectURN for Current
 * Used in the JSON schema for the LwM2M document definition as a key.
 */
export const objectURN = '3317:1.1'
