 ...
 * measurements. It also provides resources for minimum and maximum measured
 * values, as well as the minimum and maximum range that can be measured by the
 * sensor. An example measurement unit is decibels.
 *
 *
 * @see https://github.com/OpenMobileAlliance/lwm2m-registry/raw/prod/3324.xml
 *
 * ID: 3324
 * LWM2MVersion: 1.0
 * ObjectVersion: 1.1
 ...
 * Mandatory: false
 */
export type Loudness_3324 = Readonly<
	Array<{
...
/**
 * The objectURN for Loudness
 * Used in the JSON schema for the LwM2M document definition as a key.
 */
export const objectURN = '3324:1.1'
