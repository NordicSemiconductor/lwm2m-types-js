 ...
 * meter detects temperature below a pre-configured threshold. When the
 * temperature rises above the clear threshold, the alarm should be cleared
 *
 * @see https://github.com/OpenMobileAlliance/lwm2m-registry/raw/prod/10279.xml
 *
 * ID: 10279
 * LWM2MVersion: 1.0
 * ObjectVersion: 1.0
 ...
 * Mandatory: false
 */
export type LowTemperatureAlarm_10279 = Readonly<
	Array<{
		'6011': EventType_6011
...
/**
 * The objectURN for Low Temperature Alarm
 * Used in the JSON schema for the LwM2M document definition as a key.
 */
export const objectURN = '10279'
