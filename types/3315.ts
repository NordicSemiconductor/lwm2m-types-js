 ...
 * Barometer
 *
 * This IPSO object should be used with an air pressure sensor to report a
 * barometer measurement. It also provides resources for minimum/maximum
 * measured values and the minimum/maximum range that can be measured by the
 * barometer sensor. An example measurement unit is pascals.
 *
 * @see https://github.com/OpenMobileAlliance/lwm2m-registry/raw/prod/3315.xml
 *
 * ID: 3315
 * LWM2MVersion: 1.0
 * ObjectVersion: 1.1
 ...
 * Mandatory: false
 */
export type Barometer_3315 = Readonly<
	Array<{
...
/**
 * The objectURN for Barometer
 * Used in the JSON schema for the LwM2M document definition as a key.
 */
export const objectURN = '3315:1.1'
