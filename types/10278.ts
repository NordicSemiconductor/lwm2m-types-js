 ...
 *
 * Where supported by the meter this is an alarm that should be raised if the
 * meter detects temperature above a pre-configured threshold. When the
 * temperature drops below the clear threshold, the alarm should be cleared.
 *
 * @see https://github.com/OpenMobileAlliance/lwm2m-registry/raw/prod/10278.xml
 *
 * ID: 10278
 * LWM2MVersion: 1.0
 * ObjectVersion: 1.0
 ...
 * Mandatory: false
 */
export type HighTemperatureAlarm_10278 = Readonly<
	Array<{
		'6011': EventType_6011
...
/**
 * The objectURN for High Temperature Alarm
 * Used in the JSON schema for the LwM2M document definition as a key.
 */
export const objectURN = '10278'
