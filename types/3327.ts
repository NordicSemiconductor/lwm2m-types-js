 ...
 * Conductivity
 *
 * This IPSO object should be used to report a measurement of the electric
 * conductivity of a medium or sample. It also provides resources for minimum
 * and maximum measured values, as well as the minimum and maximum range that
 * can be measured by the sensor. An example measurement unit is Siemens.
 *
 *
 * @see https://github.com/OpenMobileAlliance/lwm2m-registry/raw/prod/3327.xml
 *
 * ID: 3327
 * LWM2MVersion: 1.0
 * ObjectVersion: 1.1
 ...
 * Mandatory: false
 */
export type Conductivity_3327 = Readonly<
	Array<{
...
/**
 * The objectURN for Conductivity
 * Used in the JSON schema for the LwM2M document definition as a key.
 */
export const objectURN = '3327:1.1'
