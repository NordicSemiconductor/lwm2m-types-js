 ...
 * Gyrometer
 *
 * This IPSO Object is used to report the current reading of a gyrometer sensor
 * in 3 axes. It provides tracking of the minimum and maximum angular rate in
 * all 3 axes. An example unit of measure is radians per second.
 *
 *
 * @see https://github.com/OpenMobileAlliance/lwm2m-registry/raw/prod/3334.xml
 *
 * ID: 3334
 * LWM2MVersion: 1.0
 * ObjectVersion: 1.1
 ...
 * Mandatory: false
 */
export type Gyrometer_3334 = Readonly<
	Array<{
		'5702': XValue_5702
		'5508'?: MinXValue_5508
		'5509'?: MaxXValue_5509
...
/**
 * The objectURN for Gyrometer
 * Used in the JSON schema for the LwM2M document definition as a key.
 */
export const objectURN = '3334:1.1'
