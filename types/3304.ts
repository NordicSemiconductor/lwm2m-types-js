 ...
 * Humidity
 *
 * This IPSO object should be used with a humidity sensor to report a humidity
 * measurement. It also provides resources for minimum/maximum measured values
 * and the minimum/maximum range that can be measured by the humidity sensor. An
 * example measurement unit is relative humidity as a percentage.
 *
 * @see https://github.com/OpenMobileAlliance/lwm2m-registry/raw/prod/3304.xml
 *
 * ID: 3304
 * LWM2MVersion: 1.0
 * ObjectVersion: 1.1
 ...
 * Mandatory: false
 */
export type Humidity_3304 = Readonly<
	Array<{
...
/**
 * The objectURN for Humidity
 * Used in the JSON schema for the LwM2M document definition as a key.
 */
export const objectURN = '3304:1.1'
