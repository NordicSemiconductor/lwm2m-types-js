 ...
 * Voltage
 *
 * This IPSO object should be used with voltmeter sensor to report measured
 * voltage between two points. It also provides resources for minimum and
 * maximum measured values, as well as the minimum and maximum range that can be
 * measured by the sensor. An example measurement unit is volts.
 *
 *
 * @see https://github.com/OpenMobileAlliance/lwm2m-registry/raw/prod/3316.xml
 *
 * ID: 3316
 * LWM2MVersion: 1.0
 * ObjectVersion: 1.1
 ...
 * Mandatory: false
 */
export type Voltage_3316 = Readonly<
	Array<{
...
/**
 * The objectURN for Voltage
 * Used in the JSON schema for the LwM2M document definition as a key.
 */
export const objectURN = '3316:1.1'
