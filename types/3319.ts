 ...
 * Depth
 *
 * This IPSO object should be used to report depth measurements. It can, for
 * example, be used to describe a generic rain gauge that measures the
 * accumulated rainfall in millimetres (mm).
 *
 *
 * @see https://github.com/OpenMobileAlliance/lwm2m-registry/raw/prod/3319.xml
 *
 * ID: 3319
 * LWM2MVersion: 1.0
 * ObjectVersion: 1.1
 ...
 * Mandatory: false
 */
export type Depth_3319 = Readonly<
	Array<{
...
/**
 * The objectURN for Depth
 * Used in the JSON schema for the LwM2M document definition as a key.
 */
export const objectURN = '3319:1.1'
