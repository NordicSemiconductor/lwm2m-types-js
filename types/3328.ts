 ...
 * Power
 *
 * This IPSO object should be used to report power measurements. It also
 * provides resources for minimum and maximum measured values, as well as the
 * minimum and maximum range that can be measured by the sensor. An example
 * measurement unit is Watts. This object may be used for either real power or
 * apparent power measurements.
 *
 *
 * @see https://github.com/OpenMobileAlliance/lwm2m-registry/raw/prod/3328.xml
 *
 * ID: 3328
 * LWM2MVersion: 1.0
 * ObjectVersion: 1.1
 ...
 * Mandatory: false
 */
export type Power_3328 = Readonly<
	Array<{
...
/**
 * The objectURN for Power
 * Used in the JSON schema for the LwM2M document definition as a key.
 */
export const objectURN = '3328:1.1'
