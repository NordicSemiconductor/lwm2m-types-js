 ...
 * Acidity
 *
 * This IPSO object should be used to report an acidity measurement of a liquid.
 * It also provides resources for minimum and maximum measured values, as well
 * as the minimum and maximum range that can be measured by the sensor. An
 * example measurement unit is pH.
 *
 *
 * @see https://github.com/OpenMobileAlliance/lwm2m-registry/raw/prod/3326.xml
 *
 * ID: 3326
 * LWM2MVersion: 1.0
 * ObjectVersion: 1.1
 ...
 * Mandatory: false
 */
export type Acidity_3326 = Readonly<
	Array<{
...
/**
 * The objectURN for Acidity
 * Used in the JSON schema for the LwM2M document definition as a key.
 */
export const objectURN = '3326:1.1'
