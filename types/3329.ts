 ...
 * Power Factor
 *
 * This IPSO object should be used to report a measurement or calculation of the
 * power factor of a reactive electrical load. Power Factor is normally the
 * ratio of non-reactive power to total power. This object also provides
 * resources for minimum and maximum measured values, as well as the minimum and
 * maximum range that can be measured by the sensor.
 *
 *
 * @see https://github.com/OpenMobileAlliance/lwm2m-registry/raw/prod/3329.xml
 *
 * ID: 3329
 * LWM2MVersion: 1.0
 * ObjectVersion: 1.1
 ...
 * Mandatory: false
 */
export type PowerFactor_3329 = Readonly<
	Array<{
...
/**
 * The objectURN for Power Factor
 * Used in the JSON schema for the LwM2M document definition as a key.
 */
export const objectURN = '3329:1.1'
